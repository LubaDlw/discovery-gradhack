...
const challenges = [
  ...
  export default function StackedChallengeCarousel() {
    const [activeIndex, setActiveIndex] = useState(0);
  
    const next = () => setActiveIndex((prev) => (prev + 1) % challenges.length);
    const prev = () => setActiveIndex((prev) => (prev - 1 + challenges.length) % challenges.length);
